...
export function BookingCTA() {
  return (
    <section id="book" className="architectural-section" aria-labelledby="booking-title">
          ...
          <div className="relative min-h-[42rem] overflow-hidden border border-[rgb(var(--line))] bg-[rgb(var(--footer-bg))] text-[rgb(var(--footer-text))] shadow-[var(--shadow-soft)]">
            ...
            <div className="relative flex min-h-[42rem] items-end p-7 sm:p-12 lg:p-16">
              <div className="max-w-4xl">
                ...
                <h2 id="booking-title" className="mt-8 font-display text-5xl leading-[0.9] tracking-[-0.06em] text-white sm:text-7xl lg:text-8xl">
                ...
                <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                  <Link href={site.bookingUrl} target="_blank" rel="noopener noreferrer" className="btn btn-light">
                    Book on Airbnb <ExternalLink size={18} />
                  </Link>
                  <Link href={site.mapsUrl} target="_blank" rel="noopener noreferrer" className="btn btn-outline-light">
